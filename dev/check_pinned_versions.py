...
(CMake FetchContent, vendored static files).
...
PINS = [
    ...
    },
    {
        ...
        # file-fetcher can never resolve its `vendor/fastLoess` path
    ...
    {
        "name": "KaTeX (loess-rs crate CDN header)",
        "file": REPO_ROOT / "crates/loess-rs/katex-header.html",
        "pattern": re.compile(r"katex@(?P<version>\d+\.\d+\.\d+)"),
        "repo": "KaTeX/KaTeX",
    },
    {
        "name": "KaTeX (fastLoess crate CDN header)",
        "file": REPO_ROOT / "crates/fastLoess/katex-header.html",
        "pattern": re.compile(r"katex@(?P<version>\d+\.\d+\.\d+)"),
        "repo": "KaTeX/KaTeX",
    },
]
...
def _latest_release(repo: str, tag_prefix: str = "") -> str:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "loess-project-version-check",
        },
    )
