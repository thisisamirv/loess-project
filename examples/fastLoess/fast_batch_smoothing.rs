//! fastLoess Parallel Smoothing Examples
//!
//! This example demonstrates features specific to `fastLoess`:
...
fn main() -> Result<(), LoessError> {
    ...
    {
        println!("{}", "=".repeat(80));
        println!("fastLoess Parallel Smoothing Examples");
        println!("{}", "=".repeat(80));
        println!();
...
fn example_1_parallel_execution() -> Result<(), LoessError> {
    ...
    let model = Loess::new()
        ...
        .adapter(Batch) // Use Batch adapter from fastLoess (renamed from Standard)
...
fn example_2_sequential_fallback() -> Result<(), LoessError> {
...
fn example_3_ndarray_integration() -> Result<(), LoessError> {
...
fn example_4_robust_parallel() -> Result<(), LoessError> {
...
fn example_5_cross_validation() -> Result<(), LoessError> {
