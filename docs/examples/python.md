...
[:material-download: Download batch_smoothing.py](https://github.com/thisisamirv/loess-project/blob/main/examples/python/batch_smoothing.py)
...
[:material-download: Download streaming_smoothing.py](https://github.com/thisisamirv/loess-project/blob/main/examples/python/streaming_smoothing.py)
...
[:material-download: Download online_smoothing.py](https://github.com/thisisamirv/loess-project/blob/main/examples/python/online_smoothing.py)
