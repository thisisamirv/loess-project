...
[:material-download: Download batch_smoothing.py](https://github.com/thisisamirv/loess-project/blob/main/bindings/python/examples/batch_smoothing.py)
...
[:material-download: Download streaming_smoothing.py](https://github.com/thisisamirv/loess-project/blob/main/bindings/python/examples/streaming_smoothing.py)
...
[:material-download: Download online_smoothing.py](https://github.com/thisisamirv/loess-project/blob/main/bindings/python/examples/online_smoothing.py)
