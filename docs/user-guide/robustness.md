...
=== "R"
    ```r
    result <- fastloess(x, y, iterations = 3, robustness_method = "bisquare")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, iterations = 3, robustness_method = "huber")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, iterations = 3, robustness_method = "talwar")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, iterations = 5, return_robustness_weights = TRUE)
...
=== "R"
    ```r
    result <- fastloess(x, y, iterations = 3, scaling_method = "mad")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, iterations = 10, auto_converge = 1e-6)
    ```
