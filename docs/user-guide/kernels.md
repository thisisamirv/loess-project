...
=== "R"
    ```r
    result <- fastloess(x, y, weight_function = "tricube")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, weight_function = "gaussian")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, weight_function = "biweight")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, weight_function = "cosine")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, weight_function = "triangle")
    ```
...
=== "R"
    ```r
    result <- fastloess(x, y, weight_function = "uniform")
    ```
