#' Benchmarks for the rfastloess R package with JSON output.
#'
#' Scenarios mirror the Rust criterion benchmarks so results can be compared
#' directly via benchmarks/compare.py.
#' Results are written to benchmarks/output/rfastloess_serial.json or
#' benchmarks/output/rfastloess_parallel.json depending on the mode flag.
#'
#' Run with:
#'   Rscript benchmarks/rfastloess.R --serial
#'   Rscript benchmarks/rfastloess.R --parallel
...
# ============================================================================
# Data Generation (aligned with stats_loess.R)
# ============================================================================
...
main <- function() {
    # Require --serial or --parallel flag
    ...
    cat("=============================================================\n")
    cat(sprintf("rfastloess BENCHMARK SUITE [%s]\n", toupper(mode_label)))
    cat("=============================================================\n")
    ...
    out_path <- file.path(out_dir, sprintf("rfastloess_%s.json", mode_label))
