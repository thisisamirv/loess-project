...
mod algorithms_regression_specialized_tests;
mod algorithms_regression_tests;
mod algorithms_regression_types_tests;
...
mod integration_adapters_tests;
mod math_boundary_tests;
mod math_distance_tests;
mod math_hat_matrix_tests;
mod math_kernel_tests;
mod math_linalg_tests;
mod math_neighborhood_tests;
mod math_scaling_tests;
mod prelude_test;
mod primitives_errors_tests;
