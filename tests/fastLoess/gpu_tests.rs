...
use fastLoess::internals::engine::gpu::{GLOBAL_EXECUTOR, GpuConfig, GpuExecutor};
use fastLoess::prelude::*;
use loess_rs::internals::evaluation::cv::KFold;
...
fn test_cpu_gpu_robustness_equivalence() {
    ...
    let methods = vec![
        (
            loess_rs::internals::algorithms::robustness::RobustnessMethod::Bisquare,
            "Bisquare",
        ),
        (
            loess_rs::internals::algorithms::robustness::RobustnessMethod::Huber,
            "Huber",
        ),
        (
            loess_rs::internals::algorithms::robustness::RobustnessMethod::Talwar,
            "Talwar",
        ),
    ];
...
fn test_cpu_gpu_zero_weight_fallback_equivalence() {
    ...
    let fallback_methods = vec![
        (
            loess_rs::internals::algorithms::regression::ZeroWeightFallback::UseLocalMean,
            "UseLocalMean",
        ),
        (
            loess_rs::internals::algorithms::regression::ZeroWeightFallback::ReturnOriginal,
            "ReturnOriginal",
        ),
