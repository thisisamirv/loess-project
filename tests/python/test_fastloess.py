...
- Full Loess class with all options
- Cross-validation
...
class TestLoess:
    ...
    def test_basic_smooth(self):
        ...
        loess = fastloess.Loess(fraction=0.5)
    ...
    def test_loess_different_weight_functions(self):
        ...
        for kernel in kernels:
            loess = fastloess.Loess(fraction=0.5, weight_function=kernel)
            result = loess.fit(x, y)
            assert len(result.y) == len(x)
    ...
    def test_loess_iterations(self):
        ...
        for iterations in [0, 1, 3, 5]:
            loess = fastloess.Loess(fraction=0.7, iterations=iterations)
            result = loess.fit(x, y)
            assert len(result.y) == len(x)

    def test_loess_reuse(self):
        """Test that Loess instance can be reused for multiple fits."""
...
class TestStreamingLoess:
    """Tests for the StreamingLoess class."""
    ...
    def test_streaming_returns_all_points(self):
        ...
        streaming = fastloess.StreamingLoess(fraction=0.3, chunk_size=5000)
    ...
    def test_streaming_basic(self):
        ...
        streaming = fastloess.StreamingLoess(fraction=0.1, chunk_size=1000)
        chunk_result = streaming.process_chunk(x, y)
        final_result = streaming.finalize()

        assert isinstance(chunk_result, fastloess.LoessResult)
        assert isinstance(final_result, fastloess.LoessResult)
    ...
    def test_streaming_larger_data(self):
        ...
        streaming = fastloess.StreamingLoess(fraction=0.05, chunk_size=1500)
        chunk_result = streaming.process_chunk(x, y)
        final_result = streaming.finalize()
    ...
    def test_streaming_accuracy(self):
        ...
        streaming = fastloess.StreamingLoess(fraction=0.5, chunk_size=1000)
        chunk_result = streaming.process_chunk(x, y)
        final_result = streaming.finalize()
...
class TestOnlineLoess:
    ...
    def test_online_basic(self):
        ...
        online = fastloess.OnlineLoess(fraction=0.5, window_capacity=10, min_points=3)
    ...
    def test_online_with_noise(self):
        ...
        online = fastloess.OnlineLoess(fraction=0.3, window_capacity=20, min_points=5)
...
class TestErrorHandling:
    ...
    def test_invalid_fraction_high(self):
        ...
        with pytest.raises(ValueError):
            loess = fastloess.Loess(fraction=1.5)
            loess.fit(x, y)
    ...
    def test_invalid_fraction_low(self):
        ...
        with pytest.raises(ValueError):
            loess = fastloess.Loess(fraction=0.0)
            loess.fit(x, y)
    ...
    def test_invalid_weight_function(self):
        ...
        with pytest.raises(ValueError):
            fastloess.Loess(fraction=0.5, weight_function="invalid")

    def test_invalid_robustness_method(self):
        """Test error on invalid robustness method."""
        with pytest.raises(ValueError):
            fastloess.Loess(fraction=0.5, robustness_method="invalid")
...
class TestEdgeCases:
    ...
    def test_two_points(self):
        ...
        loess = fastloess.Loess(fraction=1.0)
        result = loess.fit(x, y)
    ...
    def test_large_dataset(self):
        ...
        loess = fastloess.Loess(fraction=0.1)
        result = loess.fit(x, y)
