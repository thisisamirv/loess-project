...
#' @srrstats {RE4.10} Residuals tested in Loess residuals test.
...
test_that("Loess basic functionality works", {
    x <- c(1, 2, 3, 4, 5)
    y <- c(2, 4, 6, 8, 10)
    ...
    expect_named(
        result,
        c("x", "y", "fraction_used", "iterations_used", "dimensions")
    )
...
test_that("Loess handles different fractions", {
    set.seed(42)
...
test_that("Loess robustness iterations work", {
    set.seed(123)
    x <- seq(0, 10, length.out = 50)
    y <- sin(x) + rnorm(50, sd = 0.1)
...
test_that("Loess confidence intervals work", {
    set.seed(42)
    x <- seq(0, 10, length.out = 50)
...
test_that("Loess prediction intervals work", {
    set.seed(42)
    x <- seq(0, 10, length.out = 50)
    y <- sin(x) + rnorm(50, sd = 0.2)
...
test_that("Loess diagnostics work", {
    set.seed(42)
    x <- seq(0, 10, length.out = 50)
...
test_that("Loess residuals work", {
    set.seed(42)
    x <- seq(0, 10, length.out = 50)
    y <- sin(x) + rnorm(50, sd = 0.1)
...
test_that("Loess robustness weights work", {
    set.seed(42)
    x <- seq(0, 10, length.out = 50)
    y <- sin(x) + rnorm(50, sd = 0.1)
...
test_that("Loess cross-validation works", {
    set.seed(42)
...
test_that("Loess parallel execution works", {
    set.seed(42)
