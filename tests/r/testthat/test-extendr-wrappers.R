RLoess <- getFromNamespace("RLoess", "rfastloess") # nolint: object_name_linter.
RStreamingLoess <- getFromNamespace("RStreamingLoess", "rfastloess") # nolint: object_name_linter.
ROnlineLoess <- getFromNamespace("ROnlineLoess", "rfastloess") # nolint: object_name_linter.
