...
> Currently available for R, Python, Rust, Julia, Node.js, WebAssembly, and C++. See the [Installation Guide](https://docs.rs/loess-rs) for detailed installation instructions.
>
> ### 📚 [View the full documentation](https://docs.rs/loess-rs)
...
Read more about how LOESS works in the [Concepts](https://docs.rs/loess-rs/latest/loess_rs/doc/concepts/index.html).
...
For more details on the performance comparison, see the [Benchmarks](https://docs.rs/loess-rs) page.
