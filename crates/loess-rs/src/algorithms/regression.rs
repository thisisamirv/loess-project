//! Regression Logic
//!
//! This module provides the core data types and logic for local regression fitting (LOESS),
//! including:
...
//! @srrstats {RE2.0} Core LOESS algorithm: local linear fits with distance-based kernel weighting.
