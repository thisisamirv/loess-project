//! # LOESS — Locally Weighted Scatterplot Smoothing for Rust
//!
//! The fastest, most robust, and most feature-complete language-agnostic
//! LOESS (Locally Weighted Scatterplot Smoothing) implementation for **Rust**,
//! **Python**, and **R**.
//!
//! ## What is LOESS?
//!
//! LOESS (Locally Weighted Scatterplot Smoothing) is a nonparametric regression
...
//! ```toml
//! [dependencies]
//! loess-rs = { version = "1.1", default-features = false }
//! ```
//!
