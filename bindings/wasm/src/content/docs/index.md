---
title: fastloess-wasm
description: High-performance LOESS smoothing for WebAssembly
template: splash
hero:
  tagline: High-performance LOESS smoothing for WebAssembly
  actions:
    - text: Get Started
      link: installation/
      icon: right-arrow
...
<p align="center">
  ...
  <a href="https://github.com/thisisamirv/loess-project/actions/workflows/ci-wasm.yml"><img src="https://github.com/thisisamirv/loess-project/actions/workflows/ci-wasm.yml/badge.svg" alt="CI"></a>
</p>
...
> Currently available for R, Python, Rust, Julia, Node.js, WebAssembly, and C++. See the [Installation Guide](https://thisisamirv.github.io/loess-project/wasm/introduction/installation/) for detailed installation instructions.
>
...
Read more about how LOESS works in the [Concepts](https://thisisamirv.github.io/loess-project/wasm/introduction/concepts/).
...
For more details on the performance comparison, see the [Benchmarks](https://thisisamirv.github.io/loess-project/wasm/benchmarks/) page.
