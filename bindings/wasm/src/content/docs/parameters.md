...
```output
Residuals (first 5): [ '-0.3604', '-0.0718', '-0.3846', '-0.0990', '0.1844' ]
```
...
console.log("typeof smooth:", typeof smooth);
```

```output
typeof smooth: undefined
```
