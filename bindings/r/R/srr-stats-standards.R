...
#' srr_stats
#'
#' Standards compliance for rfastloess package (rOpenSci regression category).
...
#' @srrstatsNA {RE2.3} No centering/offsetting - LOESS is local regression.
...
#' Addressed in Rust (crates/loess, crates/fastLoess)
#'
#' @srrstats {G1.6} Benchmarks vs stats::loess in examples.
