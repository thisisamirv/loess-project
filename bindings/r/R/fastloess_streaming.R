...
#'
#' @description
#' Chunked LOESS for large datasets. Processes data in chunks to maintain
...
#' result <- fastloess_streaming(x, y, chunk_size = 5000L)
#' plot(x, y, pch = ".")
#' lines(result$x, result$y, col = "red", lwd = 2)
#'
#' @seealso \code{\link{fastloess}}, \code{\link{fastloess_online}}
#' @family fastloess
#' @export
fastloess_streaming <- function(
    x,
    y,
    fraction = 0.3,
    chunk_size = 5000L,
