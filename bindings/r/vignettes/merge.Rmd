...
Streaming LOESS processes data in fixed-size chunks with overlap. The `merge_strategy` decides how overlapping estimates from adjacent chunks are combined.
