...
Weight functions (kernels) determine how neighboring points contribute to
each local fit. Points closer to the target receive higher weights.
...
> specific requirements. The differences between kernels are usually small
> in practice.
