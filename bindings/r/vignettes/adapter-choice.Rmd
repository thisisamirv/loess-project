...
![Merge Strategies](../man/figures/merge_comparison.svg)
...
> `finalize(model)` after processing all chunks to retrieve the buffered tail.
...
- [Real-Time Processing](use-case-real-time.html) — Real-time processing guide
