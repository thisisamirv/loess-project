...
<p align="center">
  ...
  <a href="https://github.com/thisisamirv/loess-project/actions/workflows/ci-java.yml"><img src="https://github.com/thisisamirv/loess-project/actions/workflows/ci-java.yml/badge.svg" alt="CI"></a>
</p>
...
> Currently available for R, Python, Rust, Julia, Node.js, WebAssembly, C++, Go, and Java. See the [Installation Guide](https://thisisamirv.github.io/loess-project/java/introduction/installation/) for detailed installation instructions.
>
> ### 📚 [View the full documentation](https://thisisamirv.github.io/loess-project/java/)
...
Read more about how LOESS works in the [Concepts](https://thisisamirv.github.io/loess-project/java/introduction/concepts/).
...
For more details on the performance comparison, see the [Benchmarks](https://thisisamirv.github.io/loess-project/java/benchmarks/) page.
