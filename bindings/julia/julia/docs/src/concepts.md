...
<figure markdown="span">
  ![LOESS Smoothing Concept](assets/loess_concept.svg){ width="800" }
...
<figure markdown="span">
  ![Fraction Effect](assets/fraction_comparison.svg){ width="1000" }
...
<figure markdown="span">
  ![Robustness Effect](assets/robust_iter_comparison.svg){ width="800" }
...
<figure markdown="span">
  ![Intervals](assets/intervals_comparison.svg){ width="800" }
