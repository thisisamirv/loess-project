...
LOESS fits a smooth curve through a scatter plot by performing a
...
at $`x_i`$. Because no global model is assumed, LOESS adapts naturally
...
returns a `LoessResult` list. Key result fields are `$x` (input x
...
![](rfastloess-intro_files/figure-html/basic_example-1.png)
...
![](rfastloess-intro_files/figure-html/basic_example-2.png)
...
![](rfastloess-intro_files/figure-html/robust_example-1.png)
...
![](rfastloess-intro_files/figure-html/diagnostics_example-1.png)

## Streaming Processing

`StreamingLoess` processes data in fixed-size chunks and keeps only a
...
to retrieve the combined `LoessResult` covering the full input range.
...
![](rfastloess-intro_files/figure-html/streaming_example-1.png)
...
![](rfastloess-intro_files/figure-html/online_example-1.png)
