...
Unlike parametric methods (linear regression, polynomial fitting), LOESS
adapts locally to the data structure, making it ideal for:
...
Standard LOESS is sensitive to outliers. **Robustness iterations**
